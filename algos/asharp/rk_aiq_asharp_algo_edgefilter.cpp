...
AsharpResult_t init_edgefilter_params_json(RKAsharp_EdgeFilter_Params_t *pParams, CalibDbV2_Edgefilter_t *pCalibdb,  int setting_idx)
{
    ...
    int j = 0;
    int max_iso_step = 0;
    CalibDbV2_Edgefilter_TuningPara_Setting_t *pTuningSetting = NULL;
    CalibDbV2_Edgefilter_TuningPara_Setting_ISO_t *pTuning_ISO = NULL;
...
{
	AsharpResult_t res = ASHARP_RET_SUCCESS;
    CalibDbV2_Edgefilter_TuningPara_t *pSrcTuningParaV2 = NULL;
    CalibDbV2_Edgefilter_TuningPara_t *pDstTuningParaV2 = NULL;
	int setting_len =0;
	int iso_len = 0;
	...
	pDstTuningParaV2->Setting = (CalibDbV2_Edgefilter_TuningPara_Setting_t *)malloc(setting_len * sizeof(CalibDbV2_Edgefilter_TuningPara_Setting_t));
	memset(pDstTuningParaV2->Setting, 0x00, setting_len * sizeof(CalibDbV2_Edgefilter_TuningPara_Setting_t));
	pDstTuningParaV2->Setting_len = setting_len;	
	
	for(int i=0; i<setting_len; i++){
		iso_len = pSrcTuningParaV2->Setting[i].Tuning_ISO_len;
		pDstTuningParaV2->Setting[i].Tuning_ISO = (CalibDbV2_Edgefilter_TuningPara_Setting_ISO_t *)malloc(iso_len * sizeof(CalibDbV2_Edgefilter_TuningPara_Setting_ISO_t));
		memset(pDstTuningParaV2->Setting[i].Tuning_ISO, 0x00, iso_len * sizeof(CalibDbV2_Edgefilter_TuningPara_Setting_ISO_t));
