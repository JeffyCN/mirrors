...
void calcPolyTanCoeffInv(double a0, double a2, double a3, double a4, double radius, int *invPolyTanNum, double *invPolyTanCoeff);

/* 计算逆多项式(rho-cotTheta)的系数 */
void calcPolyCotCoeffInv(double a0, double a2, double a3, double a4, double radius, int *invPolyCotNum, double *invPolyCotCoeff);
...
*/
void floatMeshUpSample(
    const float *pSmallMapx,    /* [input]: mapx小表 */
