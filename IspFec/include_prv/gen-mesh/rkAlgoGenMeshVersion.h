...
*  - content:
                ...
                2. remove the dependency on OpenCV from the codes, except for the codes in the "rkAlgoGenFloatMeshCV" folder
...
*  - content:
                ...
                2. add some demo codes for 0-255 level correction, see about test004.cpp, test005.cpp, and test006.cpp

* v1.0.9
*  - date: 2023-12-28
*  - content:
                1. remove the dependency on OpenCV from the codes in function: genLdchLdcvMeshFromFloatMesh()

* v1.1.0
*  - date: 2024-01-18
*  - content:
                1. add ldcvAlignMeshW in struct "RKALGO_LDCH_LDCV_INFO_S" for LDCV mesh to do 2 bytes align

* v1.1.1
*  - date: 2024-03-15
*  - content:
                1. some adjustment about codes depended on OpenCV: only used and compiled on Windows platform
                2. add a new method for generate LDCH+LDCV mesh avoid generating full resolution mesh
...
*  - date: 2024-04-26
*  - content:
                1. add files: rkAlgoPolynomial.c/cpp and rkAlgoPolynomial.h for solving polynomial functions and fitting polynomial curves
...
*  - date: 2024-05-31
*  - content:
                1. add function(s): genFloatMeshFromOpencvFisheyeModel for generating downsample float mesh from opencv fisheye calibration result

* v1.1.4
*  - date: 2024-08-28
*  - content:
                1. add struct: RKALGO_LDCH_INFO_S
                2. some adjustment about function(s): calcLdchMeshSize, genLdchMeshZeroCorrect, genLdchMeshFromFloatMesh
                3. add function(s): genLdchMeshFromBigMap
* v1.1.5
*  - date: 2024-10-18
*  - content:
                1. add function(s): checkBigMapForLdch

* v1.1.6
*  - date: 2024-12-05
*  - content:
                1. fix the bug of not taking effect after configuring parameters correctX and correctY in genFloatMeshNLevel

* v1.1.7
*  - date: 2025-01-12
*  - content:
                1. fix a bug in function genFloatMeshNLevelInit when computing new curve's distortion coeff
                2. change all files' CRLF(\r\n, for Windows) to LF(\n, for Unix/Linux)

* v1.1.8
*  - date: 2025-03-14
*  - content:
                1. update all functions for RV1126B
                2. update all test code for all the changes about RV1126B
                3. add RV1126B FEC cmodel function lib for Windows
...
#define GEN_MESH_VER_NUM "rkAlgoGenMesh Version: 1.1.8"

#define GEN_MESH_VER_DATE "date: 2025-03-14"
