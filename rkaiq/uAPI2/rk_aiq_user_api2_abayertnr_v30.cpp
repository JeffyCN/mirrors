...
XCamReturn
rk_aiq_user_api2_abayertnrV30_SetAttrib(const rk_aiq_sys_ctx_t* sys_ctx, const rk_aiq_bayertnr_attrib_v30_t* attr)
{
...
XCamReturn
rk_aiq_user_api2_abayertnrV30_GetAttrib(const rk_aiq_sys_ctx_t* sys_ctx, rk_aiq_bayertnr_attrib_v30_t* attr)
{
    XCamReturn ret = XCAM_RETURN_NO_ERROR;
...
XCamReturn
rk_aiq_user_api2_abayertnrV30_SetStrength(const rk_aiq_sys_ctx_t* sys_ctx, const rk_aiq_bayertnr_strength_v30_t *pStrength)
{
    XCamReturn ret = XCAM_RETURN_NO_ERROR;
...
XCamReturn
rk_aiq_user_api2_abayertnrV30_GetStrength(const rk_aiq_sys_ctx_t* sys_ctx, rk_aiq_bayertnr_strength_v30_t *pStrength)
{
    XCamReturn ret = XCAM_RETURN_NO_ERROR;
    RKAIQ_API_SMART_LOCK(sys_ctx);
...
XCamReturn
rk_aiq_user_api2_abayertnrV30_GetInfo(const rk_aiq_sys_ctx_t* sys_ctx, rk_aiq_bayertnr_info_v30_t *pInfo)
{
    XCamReturn ret = XCAM_RETURN_NO_ERROR;
    RKAIQ_API_SMART_LOCK(sys_ctx);
...
XCamReturn rk_aiq_user_api2_abayertnrV30_SetStrength(
