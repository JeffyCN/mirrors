...
rk_aiq_user_api2_acnrV2_SetAttrib(const rk_aiq_sys_ctx_t* sys_ctx, rk_aiq_cnr_attrib_v2_t* attr)
{
    ...
    if (sys_ctx->cam_type == RK_AIQ_CAM_TYPE_GROUP) {
        ...
        RkAiqCamGroupAcnrV2HandleInt* algo_handle =
            camgroupAlgoHandle<RkAiqCamGroupAcnrV2HandleInt>(sys_ctx, RK_AIQ_ALGO_TYPE_ACNR);
        ...
        if (algo_handle) {
            ...
            for (auto camCtx : camgroup_ctx->cam_ctxs_array) {
                ...
                RkAiqAcnrV2HandleInt* singleCam_algo_handle =
                    algoHandle<RkAiqAcnrV2HandleInt>(camCtx, RK_AIQ_ALGO_TYPE_ACNR);
