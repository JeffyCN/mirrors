                                           ...
                                           const rk_aiq_uapi_acgc_attrib_t* attr)
{
    ...
    if (sys_ctx->cam_type == RK_AIQ_CAM_TYPE_GROUP) {
        ...
        for (auto camCtx : camgroup_ctx->cam_ctxs_array) {
            ...
            RkAiqAcgcHandleInt* singleCam_algo_handle =
                algoHandle<RkAiqAcgcHandleInt>(camCtx, RK_AIQ_ALGO_TYPE_ACGC);
        ...
        RkAiqAcgcHandleInt* algo_handle =
            algoHandle<RkAiqAcgcHandleInt>(sys_ctx, RK_AIQ_ALGO_TYPE_ACGC);
        if (algo_handle) ret = algo_handle->setAttrib(attr);
    }
