...
public:
    ...
    virtual XCamReturn rawReProc_prepare (uint32_t sequence) = 0;
    virtual void setAiqPreCtrlInfo(rk_aiq_control_preinit_t *info) = 0;
    ...
    virtual RkAiqIspUniteMode getIspUniteMode() = 0;
private:
