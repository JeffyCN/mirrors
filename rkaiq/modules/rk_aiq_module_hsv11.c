...
{
    struct isp35_hsv_cfg *cfg = &isp_params->isp_cfg->others.hsv_cfg;
    ...
    cfg->hsv_2dlut0_en         = psta->hw_hsvT_lut2d_en;
    cfg->hsv_2dlut1_en         = psta->hw_hsvT_lut2d1_en;
    cfg->hsv_2dlut2_en         = psta->hw_hsvT_lut2d2_en;
    cfg->hsv_2dlut12_cfg       = psta->hw_hsvT_lut_mode;
    ...
    switch (pdyn->lut2d.hw_hsvT_lut2d_mode) {
        case hsv_lut2d_hs2h_mode: {
            cfg->hsv_2dlut0_idx_mode  = 0;
            cfg->hsv_2dlut0_item_mode = 0;
        } break;
        case hsv_lut2d_hv2h_mode: {
            cfg->hsv_2dlut0_idx_mode  = 1;
            cfg->hsv_2dlut0_item_mode = 0;
        } break;
        case hsv_lut2d_sv2s_mode: {
            cfg->hsv_2dlut0_idx_mode  = 2;
            cfg->hsv_2dlut0_item_mode = 1;
        } break;
    ...
    switch (pdyn->lut2d1.hw_hsvT_lut2d_mode) {
        case hsv_lut2d_hs2h_mode: {
            cfg->hsv_2dlut1_idx_mode  = 0;
            cfg->hsv_2dlut1_item_mode = 0;
        } break;
        case hsv_lut2d_hv2h_mode: {
            cfg->hsv_2dlut1_idx_mode  = 1;
            cfg->hsv_2dlut1_item_mode = 0;
        } break;
        case hsv_lut2d_sv2s_mode: {
            cfg->hsv_2dlut1_idx_mode  = 2;
            cfg->hsv_2dlut1_item_mode = 1;
        } break;
        case hsv_lut2d_hs2s_mode: {
            cfg->hsv_2dlut1_idx_mode  = 0;
            cfg->hsv_2dlut1_item_mode = 1;
    ...
    switch (pdyn->lut2d2.hw_hsvT_lut2d_mode) {
        case hsv_lut2d_hs2h_mode: {
            cfg->hsv_2dlut2_idx_mode  = 0;
            cfg->hsv_2dlut2_item_mode = 0;
        } break;
        case hsv_lut2d_hv2h_mode: {
            cfg->hsv_2dlut2_idx_mode  = 1;
            cfg->hsv_2dlut2_item_mode = 0;
        } break;
        case hsv_lut2d_sv2s_mode: {
            cfg->hsv_2dlut2_idx_mode  = 2;
            cfg->hsv_2dlut2_item_mode = 1;
        } break;
        case hsv_lut2d_hs2s_mode: {
            cfg->hsv_2dlut2_idx_mode  = 0;
            cfg->hsv_2dlut2_item_mode = 1;
    ...
    for (int i = 0; i < ISP35_HSV_1DLUT_NUM; i++)
    ...
    int count = 0;
    for (int i = 0; i < ISP35_HSV_2DLUT_ROW; i++){
        for (int j = 0; j < ISP35_HSV_2DLUT_COL; j++) {
            cfg->lut0_2d[i][j] = ((uint16_t)pdyn->lut2d.hw_hsvT_lut2d_val[count]) << 2;
            cfg->lut1_2d[i][j] = ((uint16_t)pdyn->lut2d1.hw_hsvT_lut2d_val[count]) << 2;
            cfg->lut2_2d[i][j] = ((uint16_t)pdyn->lut2d2.hw_hsvT_lut2d_val[count]) << 2;
            count++;
        }
    }
