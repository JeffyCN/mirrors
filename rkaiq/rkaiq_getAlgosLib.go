...
func rkaiq_getAlgosLib(macros_map map[string]bool) []string {
    ...
    if (flag0 || flag1) {
        if (flag1 && useNewstruct) {
            static_lib = append(static_lib, "librkaiq_gic")
        } else {
    ...
    flag4 = macros_map["RKAIQ_HAVE_CAC_V30"]
    if (flag0 || flag1 || flag2 || flag4) {
        if (useNewstruct) {
            static_lib = append(static_lib, "librkaiq_cac")
        } else {
    ...
    if (flag0) {
        if useNewstruct {
            static_lib = append(static_lib, "librkaiq_ynr")
        } else {
	...
	if (flag0 || flag1) {
        if useNewstruct {
            static_lib = append(static_lib, "librkaiq_cnr")
        } else {
    ...
    if (flag0) {
        if useNewstruct {
            static_lib = append(static_lib, "librkaiq_yme")
        } else {
    ...
    if (flag0 || flag1) {
        if useNewstruct {
            static_lib = append(static_lib, "librkaiq_sharp")
        } else {
    ...
    if (flag0 || flag1) {
        if useNewstruct {
            static_lib = append(static_lib, "librkaiq_bayertnr")
        } else {
    ...
    if (flag0) {
        if useNewstruct {
            static_lib = append(static_lib, "librkaiq_gain")
        } else {
    ...
    if (flag0) {
        if useNewstruct {
            static_lib = append(static_lib, "librkaiq_blc")
        } else {
    ...
    if (flag0) {
        if useNewstruct {
            static_lib = append(static_lib, "librkaiq_3dlut")
        } else {
    ...
    if (flag0 || flag1 || flag2) {
        if useNewstruct && flag2 {
            static_lib = append(static_lib, "librkaiq_ccm")
        } else {
    ...
    if (flag0 || flag1) {
        if useNewstruct && flag2 {
            static_lib = append(static_lib, "librkaiq_gamma")
        } else {
    ...
    if (flag0) {
        if useNewstruct {
            static_lib = append(static_lib, "librkaiq_rgbir")
        } else {
    ...
    if (flag0 || flag1) {
        if useNewstruct {
            static_lib = append(static_lib, "librkaiq_ldch")
        } else {
    ...
    if (flag0) {
        if useNewstruct {
            static_lib = append(static_lib, "librkaiq_csm")
        } else {
    ...
    if (flag0) {
        if useNewstruct {
            static_lib = append(static_lib, "librkaiq_cgc")
        } else  {
    ...
    if (flag0 || flag1 || flag2 || flag3 || flag4) {
        if useNewstruct {
            static_lib = append(static_lib, "librkaiq_demosaic")
        } else {
    ...
    if (flag0 || flag1 || flag2) {
        if useNewstruct {
            static_lib = append(static_lib, "librkaiq_lsc")
        } else {
    ...
    if (flag0 || flag1) {
        if useNewstruct && flag2 {
            static_lib = append(static_lib, "librkaiq_dpc")
        } else {
    ...
    if (flag0) {
        if useNewstruct && flag2 {
            static_lib = append(static_lib, "librkaiq_cp")
        } else {
    ...
    if (flag0) {
        if useNewstruct && flag2 {
            static_lib = append(static_lib, "librkaiq_ie")
        } else {
