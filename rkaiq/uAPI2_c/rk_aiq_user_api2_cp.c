...
#include "aiq_core_c/algo_handlers/RkAiqCpHandler.h"
...
rk_aiq_user_api2_cp_SetAttrib(const rk_aiq_sys_ctx_t* sys_ctx, cp_api_attrib_t* attr)
{
	...
	int type = RESULT_TYPE_CP_PARAM;
	int man_param_size = sizeof(cp_param_t);
	int aut_param_size = sizeof(cp_param_auto_t);
