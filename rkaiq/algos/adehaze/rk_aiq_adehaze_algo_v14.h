...
#ifndef __RK_AIQ_ADEHAZE_ALGO_V14_H__
#define __RK_AIQ_ADEHAZE_ALGO_V14_H__
...
XCamReturn AdehazeProcess(AdehazeHandle_t* para, dehaze_stats_v14_t* pStats, bool stats_true,
...
#endif  //__RK_AIQ_ADEHAZE_ALGO_V14_H__