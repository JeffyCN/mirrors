...
#ifndef _RK_AIQ_TYPES_ABAYER2DNR_ALGO_PRVT_V23_H_
#define _RK_AIQ_TYPES_ABAYER2DNR_ALGO_PRVT_V23_H_
...
//anr context
typedef struct Abayer2dnr_Context_V23_s {
    ...
    rk_aiq_bayer2dnr_strength_v23_t stStrength;
