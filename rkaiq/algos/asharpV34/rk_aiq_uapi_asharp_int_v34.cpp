/*
 * rk_aiq_uapi_asharp_int_v34.cpp
 *
...
#define ASHSRPV34_STRENGTH_SLOPE_FACTOR (4.0)

XCamReturn rk_aiq_uapi_asharpV34_SetAttrib(RkAiqAlgoContext* ctx,
                                           const rk_aiq_sharp_attrib_v34_t* attr, bool need_sync) {
#if RKAIQ_HAVE_SHARP_V34
    Asharp_Context_V34_t* pAsharpCtx = (Asharp_Context_V34_t*)ctx;
...
XCamReturn rk_aiq_uapi_asharpV34_GetAttrib(const RkAiqAlgoContext* ctx,
...
XCamReturn rk_aiq_uapi_asharpV34_SetStrength(RkAiqAlgoContext* ctx,
                                             const rk_aiq_sharp_strength_v34_t* pStrength) {
    Asharp_Context_V34_t* pAsharpCtx = (Asharp_Context_V34_t*)ctx;
    float fslope                     = ASHSRPV34_STRENGTH_SLOPE_FACTOR;
...
XCamReturn rk_aiq_uapi_asharpV34_GetStrength(const RkAiqAlgoContext* ctx,
...
XCamReturn rk_aiq_uapi_asharpV34_GetInfo(const RkAiqAlgoContext* ctx,
