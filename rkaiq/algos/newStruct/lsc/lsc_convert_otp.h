...
#ifndef _RK_AIQ_LSC_CONVERT_OTP_H_
#define _RK_AIQ_LSC_CONVERT_OTP_H_
...
void convertLscTableParameter(lsc_resolution_t *cur_res, lsc_otp_grad_t *otpGrad, RkAiqBayerPattern_t bayerPattern);
