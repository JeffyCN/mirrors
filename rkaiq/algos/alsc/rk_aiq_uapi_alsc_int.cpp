                           ...
                           rk_aiq_lsc_attrib_t *attr)
{
    ...
    if (lsc_contex->mCurAtt.stManual.lsc_sect_size_x[0] > 10 &&
        lsc_contex->mCurAtt.stManual.lsc_sect_size_y[0] > 8) {
              goto end;
    } else {
       if (lsc_contex->lscHwConf.x_size_tbl[0] == 0 &&
              lsc_contex->lscHwConf.y_size_tbl[0] == 0) {
              goto end;
       }
    }
