...
class RkAiqDrcHandleInt : virtual public RkAiqHandle {
public:
    explicit RkAiqDrcHandleInt(RkAiqAlgoDesComm* des, RkAiqCore* aiqCore)
        : RkAiqHandle(des, aiqCore) {}
    virtual ~RkAiqDrcHandleInt() {
        RkAiqHandle::deInit();
    };
    ...
    XCamReturn setAttrib(drc_api_attrib_t* attr);
    XCamReturn getAttrib(drc_api_attrib_t* attr);
    XCamReturn queryStatus(drc_status_t* status);
...
private:
    DECLARE_HANDLE_REGISTER_TYPE(RkAiqDrcHandleInt);
};
