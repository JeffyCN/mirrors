...
class RkAiqMergeHandleInt : virtual public RkAiqHandle {
public:
    explicit RkAiqMergeHandleInt(RkAiqAlgoDesComm* des, RkAiqCore* aiqCore)
        : RkAiqHandle(des, aiqCore) {}
    virtual ~RkAiqMergeHandleInt() {
        RkAiqHandle::deInit();
    };
    ...
    XCamReturn setAttrib(mge_api_attrib_t* attr);
    XCamReturn getAttrib(mge_api_attrib_t* attr);
    XCamReturn queryStatus(mge_status_t* status);
...
private:
    DECLARE_HANDLE_REGISTER_TYPE(RkAiqMergeHandleInt);
};
