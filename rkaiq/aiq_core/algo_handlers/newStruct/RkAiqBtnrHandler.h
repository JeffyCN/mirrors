 ...
 */
#ifndef _RK_AIQ_BTNR_HANDLE_INT_H_
#define _RK_AIQ_BTNR_HANDLE_INT_H_
...
class RkAiqBtnrHandleInt : virtual public RkAiqHandle {
public:
    explicit RkAiqBtnrHandleInt(RkAiqAlgoDesComm* des, RkAiqCore* aiqCore)
        : RkAiqHandle(des, aiqCore) {}
    virtual ~RkAiqBtnrHandleInt() {
        RkAiqHandle::deInit();
    };
...
private:
    DECLARE_HANDLE_REGISTER_TYPE(RkAiqBtnrHandleInt);
};
