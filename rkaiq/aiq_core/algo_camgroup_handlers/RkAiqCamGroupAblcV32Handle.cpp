...
XCamReturn RkAiqCamGroupAblcV32HandleInt::setAttrib(const rk_aiq_blc_attrib_V32_t* att) {
    ENTER_ANALYZER_FUNCTION();
    LOGD_ABLC("%s:%d\n", __FUNCTION__, __LINE__);
...
XCamReturn RkAiqCamGroupAblcV32HandleInt::getAttrib(rk_aiq_blc_attrib_V32_t* att) {
    ENTER_ANALYZER_FUNCTION();
    LOGD_ABLC("%s:%d\n", __FUNCTION__, __LINE__);
