...
public:
    ...
    rk_aiq_core_analyze_type_e getType() const {
        return mGroupType;
    }
    uint64_t getDepsFlag() const {
        return mDepsFlag;
    }
...
public:
    ...
    void rmAlgoHandle(int algo_type);
