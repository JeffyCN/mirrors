...
set(RKAIQ_ENABLE_CAMGROUP    TRUE  CACHE INTERNAL "Build rkaiq's camera group algorithms")
...
set(RKAIQ_HAVE_MULTIISP      TRUE  CACHE INTERNAL "Build rkaiq's Dual ISP")
set(RKAIQ_ENABLE_AF          TRUE  CACHE INTERNAL "Build rkaiq's AF algorithm")
...
set(RKAIQ_IMPLEMENT_C	FALSE CACHE INTERNAL "Build rkaiq with C implementation")
set(RKAIQ_BUILD_IQBINFORRTT	FALSE CACHE INTERNAL "Build rkaiq with iqBinForRtt")
set(RKAIQ_DISABLE_J2S FALSE CACHE INTERNAL "Build rkaiq with j2s")
set(RKAIQ_ENABLE_SAMPLE_THREAD_POOL_WAIT FALSE CACHE BOOL "Enable sample of thread pool wait" FORCE)

if (RKAIQ_TARGET_SOC STREQUAL "rv1126b")
    set(RKAIQ_ISP_VERSION        "35"  CACHE INTERNAL "ISP hardware version 35"     FORCE)
    set(RKAIQ_NEWSTRUCT_TEST     TRUE)
    set(RKAIQ_IMPLEMENT_C	TRUE)
    #set(RKAIQ_BUILD_IQBINFORRTT TRUE)
    set(RKAIQ_HAVE_FAKECAM      TRUE)
	set(RKAIQ_ENABLE_AF          TRUE CACHE INTERNAL "Build rkaiq's AF algorithm")
    option(RKAIQ_HAVE_DUMPSYS "Have dumpsys" ON)
elseif (RKAIQ_TARGET_SOC STREQUAL "rv1103b")
    set(RKAIQ_ISP_VERSION        "33"  CACHE INTERNAL "ISP hardware version 33"     FORCE)
    set(RKAIQ_NEWSTRUCT_TEST     TRUE)
    set(RKAIQ_IMPLEMENT_C	TRUE)
    set(RKAIQ_BUILD_IQBINFORRTT TRUE)
    set(RKAIQ_HAVE_FAKECAM      TRUE)
    ...
    option(RKAIQ_HAVE_DUMPSYS "Have dumpsys" ON)
elseif (RKAIQ_TARGET_SOC STREQUAL "rk3576")
...
set(RKAIQ_HAVE_AMTD   TRUE CACHE INTERNAL "Build rkaiq's AMTD"      FORCE)
...
set(RKAIQ_HAVE_ENHANCE   FALSE CACHE INTERNAL "Build rkaiq's ENHANCE"       FORCE)
set(RKAIQ_HAVE_HISTEQ   FALSE CACHE INTERNAL "Build rkaiq's HISTEQ"       FORCE)
set(RKAIQ_HAVE_HSV   FALSE CACHE INTERNAL "Build rkaiq's HSV"       FORCE)
if (RKAIQ_ISP_VERSION STREQUAL "35")
    ...
    set(RKAIQ_HAVE_DEHAZE   FALSE CACHE INTERNAL "Build rkaiq's DEHAZE"       FORCE)
    set(RKAIQ_HAVE_ENHANCE   TRUE CACHE INTERNAL "Build rkaiq's ENHANCE"       FORCE)
    set(RKAIQ_HAVE_HISTEQ   TRUE CACHE INTERNAL "Build rkaiq's HISTEQ"       FORCE)
    set(RKAIQ_HAVE_HSV   TRUE CACHE INTERNAL "Build rkaiq's HSV"       FORCE)
    set(RKAIQ_HAVE_3DLUT FALSE  CACHE INTERNAL "Build rkaiq's 3DLUT"       FORCE)
    set(RKAIQ_HAVE_RGBIR_REMOSAIC   true CACHE INTERNAL "Build rkaiq's RGB remosaic"       FORCE)
    set(RKAIQ_HAVE_AIBNR TRUE  CACHE INTERNAL "Build AIBNR"       FORCE)
    set(RKAIQ_HAVE_AIRMS TRUE  CACHE INTERNAL "Build AIRMS"       FORCE)
    set(RKAIQ_HAVE_AIYNR TRUE  CACHE INTERNAL "Build AIYNR"       FORCE)
    set(RKAIQ_HAVE_FPNSW TRUE CACHE INTERNAL "Build rkaiq's FPNSW"       FORCE)
    set(RKAIQ_HAVE_MEMC TRUE CACHE INTERNAL "Build rkaiq's MEMC"       FORCE)
    set(RKAIQ_HAVE_ASD  TRUE CACHE INTERNAL "Build rkaiq's ASD"       FORCE)
elseif (RKAIQ_ISP_VERSION STREQUAL "33")
    set(RKAIQ_HAVE_BAYERNR  FALSE CACHE INTERNAL "Build rkaiq's BAYERNR"      FORCE)
    set(RKAIQ_HAVE_BAYER2DNR  FALSE CACHE INTERNAL "Build rkaiq's BAYER2DNR"  FORCE)
    set(RKAIQ_HAVE_DEHAZE   FALSE CACHE INTERNAL "Build rkaiq's DEHAZE"       FORCE)
    set(RKAIQ_HAVE_ENHANCE   TRUE CACHE INTERNAL "Build rkaiq's ENHANCE"       FORCE)
    ...
    set(RKAIQ_HAVE_HSV   TRUE CACHE INTERNAL "Build rkaiq's HSV"       FORCE)
    set(RKAIQ_HAVE_3DLUT FALSE  CACHE INTERNAL "Build rkaiq's 3DLUT"       FORCE)
elseif (RKAIQ_ISP_VERSION STREQUAL "39")
    set(RKAIQ_HAVE_BAYERNR  FALSE CACHE INTERNAL "Build rkaiq's BAYERNR"      FORCE)
    set(RKAIQ_HAVE_BAYER2DNR  FALSE CACHE INTERNAL "Build rkaiq's BAYER2DNR"  FORCE)
...
if (RKAIQ_ISP_VERSION STREQUAL "35")
    ...
    set(RKAIQ_HAVE_AWB_V39  TRUE  CACHE INTERNAL "Build rkaiq's AWB version 39"      FORCE)
    set(RKAIQ_HAVE_AWB_V33  TRUE  CACHE INTERNAL "Build rkaiq's AWB version 33"      FORCE)
    ...
    set(RKAIQ_HAVE_GIC_V3   TRUE  CACHE INTERNAL "Build rkaiq's GIC version 2"       FORCE)
    ...
    set(RKAIQ_HAVE_CAC_V30  TRUE  CACHE INTERNAL  "Build rkaiq's CAC version 13"   FORCE)
    ...
    set(RKAIQ_HAVE_YNR_V40  FALSE  CACHE INTERNAL "Build rkaiq's YNR version 40"      FORCE)
    set(RKAIQ_HAVE_YNR_V41  TRUE  CACHE INTERNAL "Build rkaiq's YNR version 41"      FORCE)
    ...
    set(RKAIQ_HAVE_CNR_V35  FALSE  CACHE INTERNAL "Build rkaiq's CNR version 35"      FORCE)
    set(RKAIQ_HAVE_CNR_V36  true  CACHE INTERNAL "Build rkaiq's CNR version 36"      FORCE)
    ...
    set(RKAIQ_HAVE_SHARP_V40 FALSE  CACHE INTERNAL "Build rkaiq's SHARP version 40"     FORCE)
    set(RKAIQ_HAVE_SHARP_V41 TRUE  CACHE INTERNAL "Build rkaiq's SHARP version 41"     FORCE)
    ...
    set(RKAIQ_HAVE_BAYERTNR_V41  FALSE  CACHE INTERNAL "Build rkaiq's BAYERTNR version 41"   FORCE)
    set(RKAIQ_HAVE_BAYERTNR_V42  true  CACHE INTERNAL "Build rkaiq's BAYERTNR version 42"   FORCE)
    ...
    set(RKAIQ_HAVE_AMTD_V1   TRUE CACHE INTERNAL "Build rkaiq's AMTD  version 1"      FORCE)
    ...
    set(RKAIQ_HAVE_MERGE_V13   TRUE CACHE INTERNAL "Build rkaiq's MERGE version 13"       FORCE)
    ...
    set(RKAIQ_HAVE_DRC_V21   TRUE CACHE INTERNAL "Build rkaiq's DRC version 21"       FORCE)
    ...
    set(RKAIQ_HAVE_HISTEQ_V10   true CACHE INTERNAL "Build rkaiq's HISTEQ version 10"       FORCE)
    set(RKAIQ_HAVE_ENHANCE_V10   true CACHE INTERNAL "Build rkaiq's ENHANCE version 10"       FORCE)
    ...
    set(RKAIQ_HAVE_DEBAYER_V4   FALSE CACHE INTERNAL "Build rkaiq's DEBAYER version 3"       FORCE)
    ...
    set(RKAIQ_HAVE_ASD_V11  TRUE CACHE INTERNAL "Build rkaiq's ASD version 11"       FORCE)
    set(RKAIQ_HAVE_LDCH  FALSE  CACHE INTERNAL "Build rkaiq's LDCH"    FORCE)
    set(RKAIQ_HAVE_LDCH_V21 FALSE CACHE INTERNAL "Build rkaiq's LDCH version 21"    FORCE)
    set(RKAIQ_HAVE_LDCH_V22 TRUE CACHE INTERNAL "Build rkaiq's LDCH version 22"    FORCE)
    set(RKAIQ_HAVE_HSV_V10 FALSE CACHE INTERNAL "Build rkaiq's HSV version 10"       FORCE)
    set(RKAIQ_HAVE_HSV_V11 TRUE CACHE INTERNAL "Build rkaiq's HSV version 11"       FORCE)
elseif (RKAIQ_ISP_VERSION STREQUAL "33")
    set(RKAIQ_HAVE_AWB_V20  FALSE CACHE INTERNAL "Build rkaiq's AWB version 20"      FORCE)
    set(RKAIQ_HAVE_AWB_V21  FALSE  CACHE INTERNAL "Build rkaiq's AWB version 21"      FORCE)
    set(RKAIQ_HAVE_AWB_V32  FALSE  CACHE INTERNAL "Build rkaiq's AWB version 32"      FORCE)
    ...
    set(RKAIQ_HAVE_YNR_V22  FALSE  CACHE INTERNAL "Build rkaiq's YNR version 22"      FORCE)
    set(RKAIQ_HAVE_YNR_V24  FALSE  CACHE INTERNAL "Build rkaiq's YNR version 24"      FORCE)
    set(RKAIQ_HAVE_YNR_V40  true  CACHE INTERNAL "Build rkaiq's YNR version 40"      FORCE)
    set(RKAIQ_HAVE_UVNR_V1  FALSE CACHE INTERNAL "Build rkaiq's UVNR version 1"      FORCE)
    set(RKAIQ_HAVE_CNR_V1   FALSE CACHE INTERNAL "Build rkaiq's CNR version 1"       FORCE)
    set(RKAIQ_HAVE_CNR_V2   FALSE CACHE INTERNAL "Build rkaiq's CNR version 2"       FORCE)
    set(RKAIQ_HAVE_CNR_V30  FALSE  CACHE INTERNAL "Build rkaiq's CNR version 30"      FORCE)
    set(RKAIQ_HAVE_CNR_V30_LITE  FALSE  CACHE INTERNAL "Build rkaiq's CNR version 30Lite"      FORCE)
    set(RKAIQ_HAVE_CNR_V31  FALSE  CACHE INTERNAL "Build rkaiq's CNR version 31"      FORCE)
    set(RKAIQ_HAVE_CNR_V35  true  CACHE INTERNAL "Build rkaiq's CNR version 35"      FORCE)
    set(RKAIQ_HAVE_SHARP_V1 FALSE CACHE INTERNAL "Build rkaiq's SHARP version 1"     FORCE)
    set(RKAIQ_HAVE_SHARP_V3 FALSE CACHE INTERNAL "Build rkaiq's SHARP version 3"     FORCE)
    set(RKAIQ_HAVE_SHARP_V4 FALSE  CACHE INTERNAL "Build rkaiq's SHARP version 4"     FORCE)
    set(RKAIQ_HAVE_SHARP_V33 FALSE  CACHE INTERNAL "Build rkaiq's SHARP version 33"     FORCE)
    set(RKAIQ_HAVE_SHARP_V33_LITE FALSE  CACHE INTERNAL "Build rkaiq's SHARP version 33Lite"     FORCE)
    set(RKAIQ_HAVE_SHARP_V34 FALSE  CACHE INTERNAL "Build rkaiq's SHARP version 34"     FORCE)
    set(RKAIQ_HAVE_SHARP_V40 true  CACHE INTERNAL "Build rkaiq's SHARP version 40"     FORCE)
    set(RKAIQ_HAVE_MFNR_V1  FALSE CACHE INTERNAL "Build rkaiq's MFNR version 1"      FORCE)
    set(RKAIQ_HAVE_BAYERNR_V1  FALSE CACHE INTERNAL "Build rkaiq's BAYERNR version 1"      FORCE)
    set(RKAIQ_HAVE_BAYERNR_V2  FALSE CACHE INTERNAL "Build rkaiq's BAYERNR version 2"      FORCE)
    set(RKAIQ_HAVE_BAYER2DNR_V2  FALSE CACHE INTERNAL "Build rkaiq's BAYER2DNR version 2"  FORCE)
    ...
    set(RKAIQ_HAVE_BAYERTNR_V23_LITE  FALSE  CACHE INTERNAL "Build rkaiq's BAYERTNR version 23Lite"   FORCE)
    set(RKAIQ_HAVE_BAYERTNR_V30  FALSE  CACHE INTERNAL "Build rkaiq's BAYERTNR version 30"   FORCE)
    set(RKAIQ_HAVE_BAYERTNR_V41  true  CACHE INTERNAL "Build rkaiq's BAYERTNR version 41"   FORCE)
    set(RKAIQ_HAVE_GAIN_V1  FALSE CACHE INTERNAL "Build rkaiq's GAIN version 1"      FORCE)
    set(RKAIQ_HAVE_GAIN_V2  TRUE  CACHE INTERNAL "Build rkaiq's GAIN version 2"      FORCE)
    set(RKAIQ_HAVE_BLC_V1   FALSE  CACHE INTERNAL "Build rkaiq's BLC  version 1"      FORCE)
    set(RKAIQ_HAVE_BLC_V32   TRUE  CACHE INTERNAL "Build rkaiq's BLC  version 32"      FORCE)
    set(RKAIQ_HAVE_ANR_V1   FALSE CACHE INTERNAL "Build rkaiq's ANR  version 1"      FORCE)
    set(RKAIQ_HAVE_AMTD_V1   FALSE CACHE INTERNAL "Build rkaiq's AMTD  version 1"      FORCE)
    set(RKAIQ_HAVE_AMD_V1   FALSE CACHE INTERNAL "Build rkaiq's AMD  version 1"      FORCE)
    set(RKAIQ_HAVE_YUVME_V1  FALSE  CACHE INTERNAL "Build rkaiq's YUVME version 1"      FORCE)
	if(RKAIQ_HAVE_AF)
		set(RKAIQ_HAVE_PDAF     FALSE CACHE INTERNAL "Build rkaiq's PDAF"                FORCE)
		set(RKAIQ_HAVE_AF_V33   FALSE CACHE INTERNAL "Build rkaiq's AF version 32"       FORCE)
		set(RKAIQ_HAVE_AF_V20   FALSE CACHE INTERNAL "Build rkaiq's AF version 20"       FORCE)
		set(RKAIQ_HAVE_AF_V30   FALSE CACHE INTERNAL "Build rkaiq's AF version 30"       FORCE)
		set(RKAIQ_HAVE_AF_V31   FALSE CACHE INTERNAL "Build rkaiq's AF version 31"       FORCE)
		set(RKAIQ_ONLY_AF_STATS_V31 FALSE CACHE INTERNAL "Build only AF stats version 31" FORCE)
    ...
    set(RKAIQ_HAVE_DEBAYER_V4   TRUE CACHE INTERNAL "Build rkaiq's DEBAYER version 3"       FORCE)
    set(RKAIQ_HAVE_LSC_V1   FALSE CACHE INTERNAL "Build rkaiq's LSC version 1"       FORCE)
    set(RKAIQ_HAVE_LSC_V2   FALSE CACHE INTERNAL "Build rkaiq's LSC version 2"       FORCE)
    set(RKAIQ_HAVE_LSC_V3   TRUE CACHE INTERNAL "Build rkaiq's LSC version 3"       FORCE)
    set(RKAIQ_HAVE_DPCC_V1   FALSE CACHE INTERNAL "Build rkaiq's DPCC version 1"       FORCE)
    ...
    set(RKAIQ_HAVE_LDCH_V21 FALSE CACHE INTERNAL "Build rkaiq's LDCH version 21"    FORCE)
    set(RKAIQ_HAVE_LDCH_V22 TRUE CACHE INTERNAL "Build rkaiq's LDCH version 22"    FORCE)
    set(RKAIQ_HAVE_HSV_V10 TRUE CACHE INTERNAL "Build rkaiq's HSV version 10"       FORCE)
elseif (RKAIQ_ISP_VERSION STREQUAL "39")
    set(RKAIQ_HAVE_AWB_V20  FALSE CACHE INTERNAL "Build rkaiq's AWB version 20"      FORCE)
    set(RKAIQ_HAVE_AWB_V21  FALSE  CACHE INTERNAL "Build rkaiq's AWB version 21"      FORCE)
    set(RKAIQ_HAVE_AWB_V32  FALSE  CACHE INTERNAL "Build rkaiq's AWB version 32"      FORCE)
    set(RKAIQ_HAVE_AWB_V32LT  FALSE  CACHE INTERNAL "Build rkaiq's AWB version 32Lite"      FORCE)
    set(RKAIQ_HAVE_AWB_V39  TRUE  CACHE INTERNAL "Build rkaiq's AWB version 39"      FORCE)
    set(RKAIQ_HAVE_AWB_V33  FALSE  CACHE INTERNAL "Build rkaiq's AWB version 39"      FORCE)
    set(RKAIQ_HAVE_GIC_V1   FALSE CACHE INTERNAL "Build rkaiq's GIC version 1"       FORCE)
    ...
    set(RKAIQ_HAVE_LDCH_V21 FALSE CACHE INTERNAL "Build rkaiq's LDCH version 21"    FORCE)
    set(RKAIQ_HAVE_LDCH_V22 TRUE CACHE INTERNAL "Build rkaiq's LDCH version 22"    FORCE)
    set(RKAIQ_HAVE_LDCV_V22 TRUE CACHE INTERNAL "Build rkaiq's LDCV version 22"    FORCE)
elseif (RKAIQ_ISP_VERSION STREQUAL "32_lite")
    set(RKAIQ_HAVE_AWB_V20  FALSE CACHE INTERNAL "Build rkaiq's AWB version 20"      FORCE)
    set(RKAIQ_HAVE_AWB_V21  FALSE  CACHE INTERNAL "Build rkaiq's AWB version 21"      FORCE)
    ...
    set(RKAIQ_HAVE_AWB_V39  FALSE  CACHE INTERNAL "Build rkaiq's AWB version 39"      FORCE)
    set(RKAIQ_HAVE_AWB_V33  FALSE  CACHE INTERNAL "Build rkaiq's AWB version 39"      FORCE)
    set(RKAIQ_HAVE_GIC_V1   FALSE CACHE INTERNAL "Build rkaiq's GIC version 1"       FORCE)
    set(RKAIQ_HAVE_GIC_V2   FALSE  CACHE INTERNAL "Build rkaiq's GIC version 2"       FORCE)
    set(RKAIQ_HAVE_ORB_V1   FALSE CACHE INTERNAL "Build rkaiq's ORB version 1"       FORCE)
    ...
    set(RKAIQ_HAVE_AIE_V10   TRUE CACHE INTERNAL "Build rkaiq's AIE version 10"       FORCE)
    set(RKAIQ_HAVE_ASD_V10  FALSE CACHE INTERNAL "Build rkaiq's ASD version 10"       FORCE)
    set(RKAIQ_HAVE_LDC  FALSE CACHE INTERNAL "Build rkaiq's LDC version 22"       FORCE)
elseif (RKAIQ_ISP_VERSION STREQUAL "32")
    set(RKAIQ_HAVE_AWB_V20  FALSE CACHE INTERNAL "Build rkaiq's AWB version 20"      FORCE)
    set(RKAIQ_HAVE_AWB_V21  FALSE  CACHE INTERNAL "Build rkaiq's AWB version 21"      FORCE)
    set(RKAIQ_HAVE_AWB_V32  TRUE  CACHE INTERNAL "Build rkaiq's AWB version 32"      FORCE)
...
elseif (RKAIQ_ISP_VERSION STREQUAL "20")
    ...
    set(RKAIQ_HAVE_AIE_V10   TRUE CACHE INTERNAL "Build rkaiq's AIE version 10"       FORCE)
    set(RKAIQ_HAVE_ASD_V10   FALSE CACHE INTERNAL "Build rkaiq's ASD version 10"       FORCE)
    set(RKAIQ_HAVE_LDC  FALSE CACHE INTERNAL "Build rkaiq's LDC version 10"       FORCE)
else()
    set(RKAIQ_HAVE_AWB_V20  FALSE CACHE INTERNAL "Build rkaiq's AWB version 20"      FORCE)
    set(RKAIQ_HAVE_AWB_V21  FALSE CACHE INTERNAL "Build rkaiq's AWB version 21"      FORCE)
    set(RKAIQ_HAVE_AWB_V32  FALSE  CACHE INTERNAL "Build rkaiq's AWB version 32"      FORCE)
