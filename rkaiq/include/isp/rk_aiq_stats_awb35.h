#ifndef __TYPE_AWB_STAT_35H__
#define __TYPE_AWB_STAT_35H__
...
typedef enum awbStats_src_mode_e {
    ...
    */
    awbStats_chl2DegamOut_mode  = 2,
     /*
    reg: (sw_drc2awb_sel_en=0) && (sw_bnr2awb_sel_en=1)&&(sw_bnr_be_sel=0)
    */
   awbStats_btnrfeOut_mode = 3,
    /*
    reg: (sw_drc2awb_sel_en=0) && (sw_bnr2awb_sel_en=1) &&(sw_bnr_be_sel=1)
    */
    awbStats_btnrOut_mode = 4,
    /*
    reg: (sw_drc2awb_sel_en=1)
    */
    awbStats_drcOut_mode = 5,
