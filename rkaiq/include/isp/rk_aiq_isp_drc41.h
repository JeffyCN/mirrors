...
#ifndef _RK_AIQ_PARAM_DRC41_H_
#define _RK_AIQ_PARAM_DRC41_H_
...
typedef struct drc_preProc_dyn_s {
	...
	/* M4_GENERIC_DESC(
        M4_ALIAS(hw_drcT_lumaFilt_maxWgt),
        M4_TYPE(f32),
        M4_SIZE_EX(1,1),
        M4_RANGE_EX(0,1),
        M4_DEFAULT(1),
        ...
        M4_NOTES(TODO.
                Freq of use: low))  */
    float hw_drcT_lumaFilt_maxWgt;
	/* M4_GENERIC_DESC(
        M4_ALIAS(hw_drcT_lumaFilt_midWgt),
        M4_TYPE(f32),
        M4_SIZE_EX(1,1),
        M4_RANGE_EX(0,1),
        M4_DEFAULT(0),
        ...
        M4_NOTES(TODO.
                Freq of use: low))  */
    float hw_drcT_lumaFilt_midWgt;
	/* M4_GENERIC_DESC(
        M4_ALIAS(hw_drcT_lumaFilt_minWgt),
        M4_TYPE(f32),
        M4_SIZE_EX(1,1),
        M4_RANGE_EX(0,1),
        M4_DEFAULT(0),
