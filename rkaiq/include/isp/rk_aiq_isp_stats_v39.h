...
#ifndef _RK_AIQ_PARAM_ISP_STATS_v39_H_
#define _RK_AIQ_PARAM_ISP_STATS_v39_H_
...
typedef afStats_stats_t       rk_aiq_isp_stats_af_t;
...
typedef struct rk_aiq_isp_statistics_s {
    ...
    rk_aiq_isp_stats_af_t afStats_stats;
