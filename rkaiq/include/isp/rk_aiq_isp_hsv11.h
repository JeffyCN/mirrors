...
#ifndef _RK_AIQ_PARAM_HSV11_H_
#define _RK_AIQ_PARAM_HSV11_H_
...
typedef enum hsv_lutcfg_mode_e {
    // @reg: sw_hsv_2dlut12_cfg_en == 0
    hsv_1dAnd2d_mode = 0,
    // @reg: sw_hsv_2dlut12_cfg_en == 1
    hsv_only2d_mode = 1,
} hsv_lutcfg_mode_t;
...
typedef struct {
    ...
    hsv_lut2d_dyn_t lut2d;
        ...
        M4_ALIAS(lut2d1),
        M4_TYPE(struct),
        M4_UI_MODULE(HSV_2DLut1),
        M4_HIDE_EX(0),
        M4_RO(0),
        M4_ORDER(0),
        M4_NOTES(TODO)) */
    hsv_lut2d_dyn_t lut2d1;
        /* M4_GENERIC_DESC(
        M4_ALIAS(lut2d2),
        M4_TYPE(struct),
        M4_UI_MODULE(HSV_2DLut2),
        M4_HIDE_EX(0),
        M4_RO(0),
        M4_ORDER(0),
        M4_NOTES(TODO)) */
    hsv_lut2d_dyn_t lut2d2;
} hsv_param_dyn_t;
...
typedef struct {
    /* M4_GENERIC_DESC(
        ...
        M4_TYPE(bool),
        M4_DEFAULT(0),
        M4_GROUP(lutcfg_mode_group:hsv_1dAnd2d_mode),
        M4_HIDE_EX(0),
        M4_RO(0),
        M4_ORDER(0),
    ...
    /* M4_GENERIC_DESC(
        M4_ALIAS(hw_hsvT_lut2d1_en),
        M4_TYPE(bool),
        M4_DEFAULT(0),
        M4_GROUP(lutcfg_mode_group:hsv_only2d_mode),
        M4_HIDE_EX(0),
        M4_RO(0),
        M4_ORDER(0),
        M4_NOTES(Enable lut2d1.\nFreq of use: high))  */
    // @reg: sw_hsv_2dlut1_en
    bool hw_hsvT_lut2d1_en;
    /* M4_GENERIC_DESC(
        M4_ALIAS(hw_hsvT_lut2d1_en),
        M4_TYPE(bool),
        M4_DEFAULT(0),
        ...
        M4_RO(0),
        M4_ORDER(0),
        M4_NOTES(Enable lut2d2.\nFreq of use: high))  */
    // @reg: sw_hsv_2dlut1_en
    bool hw_hsvT_lut2d2_en;
    /* M4_GENERIC_DESC(
        M4_ALIAS(hw_hsvT_lut_mode),
        M4_TYPE(enum),
        M4_ENUM_DEF(hsv_lutcfg_mode_t),
        M4_DEFAULT(hsv_1dAnd2d_mode),
        M4_GROUP_CTRL(lutcfg_mode_group),
        M4_HIDE_EX(1),
        M4_RO(1),
        M4_ORDER(0),
        M4_NOTES(1dlut and 2dlut config mode.\n
        Freq of use: low))  */
    hsv_lutcfg_mode_t hw_hsvT_lut_mode;
} hsv_param_static_t;
