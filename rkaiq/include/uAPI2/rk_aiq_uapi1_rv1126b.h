...
#ifndef RK_AIQ_UAPI_RV1126B_H
#define RK_AIQ_UAPI_RV1126B_H
 ...
 *
 * \param[in] sys_ctx             the context returned by \ref rk_aiq_uapi_sysctl_init
 */
XCamReturn rk_aiq_uapi_sysctl_pause(rk_aiq_sys_ctx_t* sys_ctx, bool isSingleMode);
