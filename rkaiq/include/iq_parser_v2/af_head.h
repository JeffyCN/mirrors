...
typedef struct CalibDbV2_Af_PdafIsoPara_s {
    ...
    // M4_NUMBER_DESC("roiBlkCntW", "u8", M4_RANGE(1, 15), "3", M4_DIGIT(0))
    unsigned char roiBlkCntW;
    // M4_NUMBER_DESC("roiBlkCntH", "u8", M4_RANGE(1, 15), "3", M4_DIGIT(0))
    unsigned char roiBlkCntH;
    // M4_NUMBER_DESC("badPdThresh", "f32", M4_RANGE(0,1), "0", M4_DIGIT(3),M4_HIDE(0))
    float badPdRatio;
    // M4_NUMBER_DESC("pdFlatRegionRatio", "f32", M4_RANGE(0,1), "0", M4_DIGIT(3),M4_HIDE(0))
    float pdFlatRegionRatio;
...
typedef struct CalibDbV2_Af_PdafFaceAf_s {
    // M4_BOOL_DESC("enable", "0")
    bool pdFaceAfEn;
    // M4_NUMBER_DESC("pdFaceAfMaxWidthRatio", "f32", M4_RANGE(0,1), "0.5", M4_DIGIT(3),M4_HIDE(0))
    float pdFaceAfMaxWidthRatio;
    // M4_NUMBER_DESC("pdFaceAfMaxHeightRatio", "f32", M4_RANGE(0,1), "0.5", M4_DIGIT(3),M4_HIDE(0))
    float pdFaceAfMaxHeightRatio;
    // M4_NUMBER_DESC("pdFaceAfMinWidthRatio", "f32", M4_RANGE(0,1), "0.05", M4_DIGIT(3),M4_HIDE(0))
    float pdFaceAfMinWidthRatio;
    // M4_NUMBER_DESC("pdFaceAfMinHeightRatio", "f32", M4_RANGE(0,1), "0.05", M4_DIGIT(3),M4_HIDE(0))
    float pdFaceAfMinHeightRatio;
    // M4_NUMBER_DESC("pdFaceAfInRoiBlkHorNum", "u8", M4_RANGE(1, 15), "3", M4_DIGIT(0))
    unsigned char pdFaceAfInRoiBlkHorNum;
    // M4_NUMBER_DESC("pdFaceAfInRoiBlkVerNum", "u8", M4_RANGE(1, 15), "3", M4_DIGIT(0))
    unsigned char pdFaceAfInRoiBlkVerNum;
} CalibDbV2_Af_PdafFaceAf_t;
...
typedef struct CalibDbV2_Af_Pdaf_s {
    ...
    int pdResoInf_len;
    // M4_STRUCT_DESC("pdFaceAf", "normal_ui_style")
    CalibDbV2_Af_PdafFaceAf_t pdFaceAf;
    // M4_NUMBER_DESC("pdBlkValidWRatio", "f32", M4_RANGE(0,1), "1.0", M4_DIGIT(3),M4_HIDE(0))
    float pdBlkValidWRatio;
    // M4_NUMBER_DESC("pdBlkValidHRatio", "f32", M4_RANGE(0,1), "1.0", M4_DIGIT(3),M4_HIDE(0))
    float pdBlkValidHRatio;
    // M4_NUMBER_DESC("pdLumaStableFrames", "u16", M4_RANGE(0,1023), "0", M4_DIGIT(0),M4_HIDE(0))
    unsigned short pdLumaStableFrames;
    // M4_NUMBER_DESC("pdLumaStableThers", "f32", M4_RANGE(0,1), "0", M4_DIGIT(3),M4_HIDE(0))
    float pdLumaStableThers;
    // M4_NUMBER_DESC("pdMonitorFramesInterval", "u16", M4_RANGE(0,1023), "0", M4_DIGIT(0),M4_HIDE(0))
    unsigned short pdMonitorFramesInterval;
} CalibDbV2_Af_Pdaf_t;
...
typedef struct Af_PdafIsoPara_s {
    ...
    /* M4_GENERIC_DESC(
        ...
        M4_RO(0),
        M4_ORDER(17),
        M4_NOTES(Ratio to detect flat region.\n
        Freq of use: low))  */
    float PdFlatRegionRatio;
    /* M4_GENERIC_DESC(
...
typedef struct Af_PdafFaceAf_s {
    /* M4_GENERIC_DESC(
        M4_ALIAS(PdFaceAfEn),
        M4_TYPE(bool),
        M4_DEFAULT(0),
        ...
        M4_RO(0),
        M4_ORDER(0),
        M4_NOTES(Enable pdaf faceaf function.\n
        Freq of use: high))  */
    bool PdFaceAfEn;
    /* M4_GENERIC_DESC(
        M4_ALIAS(PdFaceAfMaxWidthRatio),
        M4_TYPE(f32),
        M4_SIZE_EX(1,1),
        M4_RANGE_EX(0,1),
        M4_DEFAULT(0.5),
        ...
        M4_RO(0),
        M4_ORDER(1),
        M4_NOTES(Max face roi width ratio.\n
        Freq of use: high))  */
    float PdFaceAfMaxWidthRatio;
    /* M4_GENERIC_DESC(
        M4_ALIAS(PdFaceAfMaxHeightRatio),
        M4_TYPE(f32),
        M4_SIZE_EX(1,1),
        M4_RANGE_EX(0,1),
        M4_DEFAULT(0.5),
        ...
        M4_RO(0),
        M4_ORDER(2),
        M4_NOTES(Max face roi height ratio.\n
        Freq of use: high))  */
    float PdFaceAfMaxHeightRatio;
    /* M4_GENERIC_DESC(
        M4_ALIAS(PdFaceAfMinWidthRatio),
        M4_TYPE(f32),
        M4_SIZE_EX(1,1),
        M4_RANGE_EX(0,1),
        M4_DEFAULT(0.05),
        ...
        M4_RO(0),
        M4_ORDER(3),
        M4_NOTES(Min face roi width ratio.\n
        Freq of use: high))  */
    float PdFaceAfMinWidthRatio;
    /* M4_GENERIC_DESC(
        M4_ALIAS(PdFaceAfMinHeightRatio),
        M4_TYPE(f32),
        M4_SIZE_EX(1,1),
        M4_RANGE_EX(0,1),
        M4_DEFAULT(0.05),
        ...
        M4_RO(0),
        M4_ORDER(4),
        M4_NOTES(Min face roi height ratio.\n
        Freq of use: high))  */
    float PdFaceAfMinHeightRatio;
    /* M4_GENERIC_DESC(
        M4_ALIAS(PdFaceAfInRoiBlkHorNum),
        M4_TYPE(u8),
        M4_SIZE_EX(1,1),
        M4_RANGE_EX(1,15),
        M4_DEFAULT(3),
    ...
    unsigned char PdFaceAfInRoiBlkHorNum;
    /* M4_GENERIC_DESC(
        M4_ALIAS(PdFaceAfInRoiBlkVerNum),
        M4_TYPE(u8),
        M4_SIZE_EX(1,1),
        M4_RANGE_EX(1,15),
        M4_DEFAULT(3),
...
typedef struct Af_Pdaf_s {
    ...
    /* M4_GENERIC_DESC(
        ...
        M4_RO(0),
        M4_ORDER(38),
        M4_NOTES(Pdaf face information.\n
        Freq of use: high))  */
    Af_PdafFaceAf_t PdFaceAf;
    /* M4_GENERIC_DESC(
        M4_ALIAS(PdBlkValidWRatio),
        M4_TYPE(f32),
        M4_SIZE_EX(1,1),
        M4_RANGE_EX(0,1),
        M4_DEFAULT(1.0),
        ...
        M4_RO(0),
        M4_ORDER(39),
        M4_NOTES(Ratio of valid width in one block.\n
        Freq of use: low))  */
    float PdBlkValidWRatio;
    /* M4_GENERIC_DESC(
        M4_ALIAS(PdBlkValidHRatio),
        M4_TYPE(f32),
        M4_SIZE_EX(1,1),
        M4_RANGE_EX(0,1),
        M4_DEFAULT(1.0),
        ...
        M4_RO(0),
        M4_ORDER(40),
        M4_NOTES(Ratio of valid height in one block.\n
        Freq of use: low))  */
    float PdBlkValidHRatio;
    /* M4_GENERIC_DESC(
        M4_ALIAS(PdLumaStableFrames),
        M4_TYPE(u16),
        M4_SIZE_EX(1,1),
        M4_RANGE_EX(0,1023),
        M4_DEFAULT(3),
    ...
    float PdLumaStableThers;
    /* M4_GENERIC_DESC(
        M4_ALIAS(PdMonitorFramesInterval),
        M4_TYPE(u16),
        M4_SIZE_EX(1,1),
        M4_RANGE_EX(0,1023),
        M4_DEFAULT(3),
        ...
        M4_RO(0),
        M4_ORDER(43),
        M4_NOTES(Frame number to caculate pd in monitor state.\n
        Freq of use: low))  */
    unsigned short PdMonitorFramesInterval;
} Af_Pdaf_t;
