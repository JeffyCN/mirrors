...
#ifndef ___RK_AIQ_CALIB_DB_V2_TYPES_ISP35_H__
#define ___RK_AIQ_CALIB_DB_V2_TYPES_ISP35_H__
...
typedef struct {
    ...
    af_param_t af_calib;
    // M4_STRUCT_DESC("aibnr", "normal_ui_style")
    ...
    // M4_STRUCT_DESC("asd", "normal_ui_style")
    asd_api_attrib_t asd;
