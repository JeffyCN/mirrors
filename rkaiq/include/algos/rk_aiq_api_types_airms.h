...
#ifndef _RK_AIQ_API_TYPES_AIRMS_H_
#define _RK_AIQ_API_TYPES_AIRMS_H_

#include "common/rk_aiq_comm.h"

RKAIQ_BEGIN_DECLARE

typedef struct airms_api_attrib_s {
    /* M4_GENERIC_DESC(
        M4_ALIAS(opMode),
        M4_TYPE(enum),
        M4_ENUM_DEF(rk_aiq_op_mode_t),
        M4_DEFAULT(RK_AIQ_OP_MODE_MANUAL),
        M4_HIDE_EX(0),
        M4_RO(0),
        M4_ORDER(0),
