...
#ifndef _RK_AIQ_API_TYPES_SHARP_H_
#define _RK_AIQ_API_TYPES_SHARP_H_
...
typedef struct sharp_param_auto_s {
    /* M4_GENERIC_DESC(
...
typedef struct sharp_api_attrib_s {
    /* M4_GENERIC_DESC(
        M4_ALIAS(opMode),
        M4_TYPE(enum),
