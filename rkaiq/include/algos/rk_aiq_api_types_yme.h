...
#ifndef _RK_AIQ_API_TYPES_YME_H_
#define _RK_AIQ_API_TYPES_YME_H_

#include "common/rk_aiq_comm.h"

#define YME_ISO_STEP_MAX 13
...
typedef struct {
    /* M4_GENERIC_DESC(
        ...
        M4_RO(0),
        M4_ORDER(1),
        M4_NOTES(The static params of yme module))  */
    ...
    yme_params_dyn_t dyn[YME_ISO_STEP_MAX];
} yme_param_auto_t;
