...
#ifndef _RK_AIQ_API_TYPES_FPN_SW_H_
#define _RK_AIQ_API_TYPES_FPN_SW_H_
...
typedef struct {
    /* M4_GENERIC_DESC(
        ...
        M4_RO(0),
        M4_ORDER(1),
        M4_NOTES(The static params of cp module))  */
