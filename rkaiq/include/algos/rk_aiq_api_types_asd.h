...
#ifndef _RK_AIQ_API_TYPES_ASD_H_
#define _RK_AIQ_API_TYPES_ASD_H_

#include "common/rk_aiq_comm.h"
//#include "isp/rk_aiq_isp_asd30.h"

#define ASD_ISO_STEP_MAX 13

RKAIQ_BEGIN_DECLARE

typedef struct asd_param_auto_s {
    /* M4_GENERIC_DESC(
        M4_ALIAS(sta),
        M4_TYPE(struct),
    ...
    asd_params_dyn_t dyn[ASD_ISO_STEP_MAX];
} asd_param_auto_t;

typedef struct asd_api_attrib_s {
    /* M4_GENERIC_DESC(
        M4_ALIAS(opMode),
        M4_TYPE(enum),
