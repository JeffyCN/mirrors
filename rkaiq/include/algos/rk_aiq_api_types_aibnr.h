...
#ifndef _RK_AIQ_API_TYPES_AIBNR_H_
#define _RK_AIQ_API_TYPES_AIBNR_H_

#include "common/rk_aiq_comm.h"

#define AIBNR_ISO_STEP_MAX          13

RKAIQ_BEGIN_DECLARE

typedef struct aibnr_param_auto_s {
    /* M4_GENERIC_DESC(
        M4_ALIAS(sta),
        M4_TYPE(struct),
    ...
    aibnr_param_dyn_t dyn[AIBNR_ISO_STEP_MAX];
} aibnr_param_auto_t;

typedef struct aibnr_api_attrib_s {
    /* M4_GENERIC_DESC(
        M4_ALIAS(opMode),
        M4_TYPE(enum),
