...
#ifndef _RK_AIQ_API_TYPES_RGBIR_H_
#define _RK_AIQ_API_TYPES_RGBIR_H_

#include "common/rk_aiq_comm.h"

#define RGBIR_ISO_STEP_MAX 13
...
typedef struct {
    ...
    rgbir_params_dyn_t dyn[RGBIR_ISO_STEP_MAX];
} rgbir_param_auto_t;
