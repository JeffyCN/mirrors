...
#ifndef _RK_AIQ_API_TYPES_ENH_H_
#define _RK_AIQ_API_TYPES_ENH_H_

#include "common/rk_aiq_comm.h"

#define ENH_ISO_STEP_MAX 13
...
typedef struct enh_param_auto_s {
    ...
    enh_params_dyn_t dyn[ENH_ISO_STEP_MAX];
} enh_param_auto_t;

typedef struct enh_api_attrib_s {
    /* M4_GENERIC_DESC(
        M4_ALIAS(opMode),
        M4_TYPE(enum),
