...
#ifndef _RK_AIQ_API_TYPES_YNR_H_
#define _RK_AIQ_API_TYPES_YNR_H_
...
typedef struct ynr_param_auto_s {
    /* M4_GENERIC_DESC(
        ...
        M4_RO(0),
        M4_ORDER(1),
        M4_NOTES(The static params of ynr module))  */
...
typedef struct ynr_api_attrib_s {
    /* M4_GENERIC_DESC(
        M4_ALIAS(opMode),
        M4_TYPE(enum),
