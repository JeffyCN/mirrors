...
#ifndef _RK_AIQ_API_TYPES_BTNR41_H_
#define _RK_AIQ_API_TYPES_BTNR41_H_

#include "common/rk_aiq_comm.h"

#define BTNR41_ISO_STEP_MAX 13
...
typedef struct {
    ...
    /* M4_GENERIC_DESC(
        ...
        M4_ORDER(2),
        M4_NOTES(TODO))  */
    btnr_mdMe_dyn_t mdMeDyn[BTNR41_ISO_STEP_MAX];
    /* M4_GENERIC_DESC(
        M4_ALIAS(spNrDyn),
        M4_SIZE_EX(1,13),
        M4_TYPE(struct_list),
        ...
        M4_ORDER(2),
        M4_NOTES(TODO))  */
    btnr_other_dyn_t spNrDyn[BTNR41_ISO_STEP_MAX];
} btnr_param_auto_t;
