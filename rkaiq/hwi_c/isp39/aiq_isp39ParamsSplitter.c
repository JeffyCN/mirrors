...
XCamReturn isp39SplitAecParams(AiqIspParamsSplitter_t* pSplit, struct isp39_isp_params_cfg* ori,
                               struct isp39_isp_params_cfg* left,
                               struct isp39_isp_params_cfg* right) {
    XCamReturn ret = XCAM_RETURN_NO_ERROR;

    // RAWAE
    if (ori->module_cfg_update & ISP39_MODULE_RAWAE0)
        ret = AiqIspParamsSplitter_SplitRawAeBigParams(pSplit, &ori->meas.rawae0,
                                                       &left->meas.rawae0, &right->meas.rawae0);
    if (ori->module_cfg_update & ISP39_MODULE_RAWAE3)
        ret = AiqIspParamsSplitter_SplitRawAeBigParams(pSplit, &ori->meas.rawae3,
                                                       &left->meas.rawae3, &right->meas.rawae3);

    // RAWHIST
    if (ori->module_cfg_update & ISP39_MODULE_RAWHIST0)
        ret = AiqIspParamsSplitter_SplitRawHistBigParams(
            pSplit, &ori->meas.rawhist0, &left->meas.rawhist0, &right->meas.rawhist0);
    if (ori->module_cfg_update & ISP39_MODULE_RAWHIST3)
        ret = AiqIspParamsSplitter_SplitRawHistBigParams(
...
XCamReturn isp39SplitAwbParams(AiqIspParamsSplitter_t* pSplit, struct isp39_isp_params_cfg* ori,
                               struct isp39_isp_params_cfg* left,
                               struct isp39_isp_params_cfg* right) {
    XCamReturn ret = XCAM_RETURN_NO_ERROR;
...
XCamReturn isp39SplitAlscParams(AiqIspParamsSplitter_t* pSplit, struct isp39_isp_params_cfg* ori,
                                struct isp39_isp_params_cfg* left,
                                struct isp39_isp_params_cfg* right) {
...
XCamReturn isp39SplitAynrParams(AiqIspParamsSplitter_t* pSplit, struct isp39_isp_params_cfg* ori,
                                struct isp39_isp_params_cfg* left,
                                struct isp39_isp_params_cfg* right) {
    struct isp39_ynr_cfg* ynr_cfg_ori = &ori->others.ynr_cfg;
    struct isp39_ynr_cfg* ynr_cfg_lef = &left->others.ynr_cfg;
    struct isp39_ynr_cfg* ynr_cfg_rht = &right->others.ynr_cfg;
...
XCamReturn isp39SplitAsharpParams(AiqIspParamsSplitter_t* pSplit, struct isp39_isp_params_cfg* ori,
                                  struct isp39_isp_params_cfg* left,
                                  struct isp39_isp_params_cfg* right) {
    struct isp39_sharp_cfg* sharp_cfg_ori = &ori->others.sharp_cfg;
    struct isp39_sharp_cfg* sharp_cfg_lef = &left->others.sharp_cfg;
    struct isp39_sharp_cfg* sharp_cfg_rht = &right->others.sharp_cfg;
...
XCamReturn isp39SplitAfParams(AiqIspParamsSplitter_t* pSplit, struct isp39_isp_params_cfg* ori,
                              struct isp39_isp_params_cfg* left,
                              struct isp39_isp_params_cfg* right) {
    struct isp39_rawaf_meas_cfg org_af = left->meas.rawaf;
    struct isp39_rawaf_meas_cfg* l_af  = &left->meas.rawaf;
    struct isp39_rawaf_meas_cfg* r_af  = &right->meas.rawaf;
...
XCamReturn Isp39SplitIspParams(AiqIspParamsSplitter_t* pSplit, void* orig_isp_params,
                               void* isp_params) {
    XCamReturn ret = XCAM_RETURN_NO_ERROR;

    struct isp39_isp_params_cfg* left_isp_params  = (struct isp39_isp_params_cfg*)isp_params;
    struct isp39_isp_params_cfg* right_isp_params = (struct isp39_isp_params_cfg*)isp_params + 1;
    ...
    memcpy(right_isp_params, left_isp_params, sizeof(struct isp39_isp_params_cfg));
    ...
    ret = isp39SplitAecParams(pSplit, (struct isp39_isp_params_cfg*)orig_isp_params,
                              left_isp_params, right_isp_params);
    // Should return failure ?
    if (((struct isp39_isp_params_cfg*)orig_isp_params)->module_cfg_update & ISP39_MODULE_RAWAWB)
        ret = isp39SplitAwbParams(pSplit, (struct isp39_isp_params_cfg*)orig_isp_params,
                                  left_isp_params, right_isp_params);
    if (((struct isp39_isp_params_cfg*)orig_isp_params)->module_cfg_update & ISP39_MODULE_LSC)
        ret = isp39SplitAlscParams(pSplit, (struct isp39_isp_params_cfg*)orig_isp_params,
                                   left_isp_params, right_isp_params);
    if (((struct isp39_isp_params_cfg*)orig_isp_params)->module_cfg_update & ISP39_MODULE_YNR)
        ret = isp39SplitAynrParams(pSplit, (struct isp39_isp_params_cfg*)orig_isp_params,
                                   left_isp_params, right_isp_params);
    if (((struct isp39_isp_params_cfg*)orig_isp_params)->module_cfg_update & ISP39_MODULE_SHARP)
        ret = isp39SplitAsharpParams(pSplit, (struct isp39_isp_params_cfg*)orig_isp_params,
                                     left_isp_params, right_isp_params);
    if (((struct isp39_isp_params_cfg*)orig_isp_params)->module_cfg_update & ISP39_MODULE_RAWAF)
        ret = isp39SplitAfParams(pSplit, (struct isp39_isp_params_cfg*)orig_isp_params,
                                 left_isp_params, right_isp_params);
