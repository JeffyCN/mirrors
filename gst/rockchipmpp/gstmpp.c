...
gst_mpp_mpp_format_to_gst_format (MppFrameFormat mpp_format)
{
  switch (mpp_format) {
      ...
      MPP_CASE_RETURN (MPP_FMT_RGB565, GST_VIDEO_FORMAT_BGR16);
      MPP_CASE_RETURN (MPP_FMT_BGR565, GST_VIDEO_FORMAT_RGB16);
      MPP_CASE_RETURN (MPP_FMT_RGB555, GST_VIDEO_FORMAT_BGR15);
      MPP_CASE_RETURN (MPP_FMT_BGR555, GST_VIDEO_FORMAT_RGB15);
      MPP_CASE_RETURN (MPP_FMT_RGB888, GST_VIDEO_FORMAT_BGR);
      MPP_CASE_RETURN (MPP_FMT_BGR888, GST_VIDEO_FORMAT_RGB);
      MPP_CASE_RETURN (MPP_FMT_ARGB8888, GST_VIDEO_FORMAT_ABGR);
      MPP_CASE_RETURN (MPP_FMT_ABGR8888, GST_VIDEO_FORMAT_ARGB);
      MPP_CASE_RETURN (MPP_FMT_RGBA8888, GST_VIDEO_FORMAT_BGRA);
      MPP_CASE_RETURN (MPP_FMT_BGRA8888, GST_VIDEO_FORMAT_RGBA);
    default:
...
gst_mpp_gst_format_to_mpp_format (GstVideoFormat format)
{
  switch (format) {
      ...
      MPP_CASE_RETURN (GST_VIDEO_FORMAT_BGR16, MPP_FMT_RGB565);
      MPP_CASE_RETURN (GST_VIDEO_FORMAT_RGB16, MPP_FMT_BGR565);
      MPP_CASE_RETURN (GST_VIDEO_FORMAT_BGR15, MPP_FMT_RGB555);
      MPP_CASE_RETURN (GST_VIDEO_FORMAT_RGB15, MPP_FMT_BGR555);
      MPP_CASE_RETURN (GST_VIDEO_FORMAT_BGR, MPP_FMT_RGB888);
      MPP_CASE_RETURN (GST_VIDEO_FORMAT_RGB, MPP_FMT_BGR888);
      MPP_CASE_RETURN (GST_VIDEO_FORMAT_ABGR, MPP_FMT_ARGB8888);
      MPP_CASE_RETURN (GST_VIDEO_FORMAT_ARGB, MPP_FMT_ABGR8888);
      MPP_CASE_RETURN (GST_VIDEO_FORMAT_BGRA, MPP_FMT_RGBA8888);
      MPP_CASE_RETURN (GST_VIDEO_FORMAT_RGBA, MPP_FMT_BGRA8888);
      MPP_CASE_RETURN (GST_VIDEO_FORMAT_xBGR, MPP_FMT_ARGB8888);
      MPP_CASE_RETURN (GST_VIDEO_FORMAT_xRGB, MPP_FMT_ABGR8888);
      MPP_CASE_RETURN (GST_VIDEO_FORMAT_BGRx, MPP_FMT_RGBA8888);
      MPP_CASE_RETURN (GST_VIDEO_FORMAT_RGBx, MPP_FMT_BGRA8888);
    default:
      return MPP_FMT_BUTT;
  }
}
...
gst_mpp_mpp_format_to_rga_format (MppFrameFormat mpp_format)
{
  switch (mpp_format) {
      ...
      MPP_CASE_RETURN (MPP_FMT_BGR565, RK_FORMAT_RGB_565);
      MPP_CASE_RETURN (MPP_FMT_RGB888, RK_FORMAT_BGR_888);
      MPP_CASE_RETURN (MPP_FMT_BGR888, RK_FORMAT_RGB_888);
      MPP_CASE_RETURN (MPP_FMT_RGBA8888, RK_FORMAT_BGRA_8888);
      MPP_CASE_RETURN (MPP_FMT_BGRA8888, RK_FORMAT_RGBA_8888);
    default:
