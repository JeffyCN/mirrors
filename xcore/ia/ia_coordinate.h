 ...
 */
ia_coordinate
ia_coordinate_convert(const ia_coordinate_system *src_system,
...
*/
void ia_coordinate_convert_rect(const ia_coordinate_system* a_src_system_ptr,
 ...
 */
void
ia_coordinate_convert_faces(ia_face_state *face_state,
