...
#define XCAM_AE_LIB_DESCRIPTION "xcam_ae_desciption"
#define XCAM_AWB_LIB_DESCRIPTION "xcam_awb_desciption"
#define XCAM_AF_LIB_DESCRIPTION "xcam_af_desciption"
...
typedef struct _XCam3ADescription {
    ...
    XCamReturn (*configure_3a)             (XCam3AContext *context, void* dev, void* isp_stats_dev, void* isp_params_dev, uint32_t width, uint32_t height, double framerate);
...
/* C interface of AE lib */
typedef struct _XCamAEDescription {
    uint32_t                               type;
    uint32_t                               version;
    uint32_t                               size;
    XCamReturn (*create_context)           (XCam3AContext **context);
    XCamReturn (*destroy_context)          (XCam3AContext *context);
    XCamReturn (*set_stats)                (XCam3AContext *context, void *stats);
    XCamReturn (*update_ae_params)         (XCam3AContext *context, void *params);
    XCamReturn (*analyze_ae)               (XCam3AContext *context, XCamAeParam *params);
    XCamReturn (*get_results)              (XCam3AContext *context, void *params);
    XCamReturn (*combine_analyze_results)  (XCam3AContext *context, XCam3aResultHead *results[], uint32_t *res_count);
    void       (*free_results)             (XCam3AContext *context, XCam3aResultHead *results[], uint32_t res_count);
} XCamAEDescription;

/* C interface of AE lib */
typedef struct _XCamAWBDescription {
    uint32_t                               type;
    uint32_t                               version;
    uint32_t                               size;
    XCamReturn (*create_context)           (XCam3AContext **context);
    XCamReturn (*destroy_context)          (XCam3AContext *context);
    XCamReturn (*set_stats)                (XCam3AContext *context, void *stats);
    XCamReturn (*update_awb_params)        (XCam3AContext *context, void *params);
    XCamReturn (*analyze_awb)              (XCam3AContext *context, XCamAwbParam *params);
    XCamReturn (*get_results)              (XCam3AContext *context, void *params);
    XCamReturn (*combine_analyze_results)  (XCam3AContext *context, XCam3aResultHead *results[], uint32_t *res_count);
    void       (*free_results)             (XCam3AContext *context, XCam3aResultHead *results[], uint32_t res_count);
...
/* C interface of AE lib */
typedef struct _XCamAFDescription {
    uint32_t                               type;
    uint32_t                               version;
    uint32_t                               size;
    XCamReturn (*create_context)           (XCam3AContext **context);
    XCamReturn (*destroy_context)          (XCam3AContext *context);
    XCamReturn (*configure_af)             (XCam3AContext *context, uint32_t width, uint32_t height);
    XCamReturn (*set_stats)                (XCam3AContext *context, void *stats);
    XCamReturn (*update_af_params)         (XCam3AContext *context, void *params);
    XCamReturn (*analyze_af)               (XCam3AContext *context, XCamAfParam *params);
    XCamReturn (*get_results)              (XCam3AContext *context, void *params);
    XCamReturn (*combine_analyze_results)  (XCam3AContext *context, XCam3aResultHead *results[], uint32_t *res_count);
    void       (*free_results)             (XCam3AContext *context, XCam3aResultHead *results[], uint32_t res_count);
