...
X3aResultFactory::create_3a_result (XCam3aResultHead *from)
{
    ...
    case XCAM_3A_RESULT_ALL:
        result = create_all ((XCam3aResultAll*)from);
        break;
...
SmartPtr<X3aAllResult>
X3aResultFactory::create_all (XCam3aResultAll *from)
{
    XCAM_3A_RESULT_FACTORY (X3aAllResult, XCAM_3A_RESULT_ALL, from);
}
