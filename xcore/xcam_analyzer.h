...
public:
    ...
    void set_video_device(SmartPtr<V4l2Device> &dev) {
        XCAM_ASSERT (!_device.ptr());
        _device = dev;
    }

    void set_isp_device(SmartPtr<V4l2Device> &dev) {
        XCAM_ASSERT (!_ispdevice.ptr());
        _ispdevice = dev;
    }*/

    void set_video_device(void* dev) {
        _device = (V4l2Device*)dev;
    }

    void set_isp_stats_device(void* dev) {
        _isp_stats_device = (V4l2Device*)dev;
    }

    void set_isp_params_device(void* dev) {
    ...
    V4l2Device* _device;
    V4l2Device* _isp_stats_device;
    V4l2Device* _isp_params_device;
