...
protected:
    void *load_library (const char *lib_path, const int type = 0);
    void *get_symbol (void* handle, const char *symbol = NULL);
    virtual void *load_symbol (void* handle, const int type = 0) = 0;
    bool close_handle ();
