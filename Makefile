...
PROJECT_DIR	?= /home/lee/rv1126/external/rga
...
AS    	?= as
LD    	?= ld
CC    	?= /home/lee/rv1126/buildroot/output/rockchip_puma/host/bin/arm-linux-gnueabihf-gcc
CXX   	?= /home/lee/rv1126/buildroot/output/rockchip_puma/host/bin/arm-linux-gnueabihf-g++
CPP   	?= $(CC) -E
AR      ?= ar rcs
NM      ?= nm
STRIP   ?= strip
...
CFLAGS     	:= $(if $(DEBUG),-g -Wall, -O2 -Wall) -DLINUX
...
ifeq ($(LIBDRM),y)
LD_LIBS += -ldrm
PRG_INC_DIR += /home/lee/rv1126/buildroot/output/rockchip_puma/host/include/
endif
