...
typedef struct texEst_noiseEst_dyn_s {
    ...
    /* M4_GENERIC_DESC(
        ...
        M4_SIZE_EX(1,17),
        M4_RANGE_EX(0,2047),
        M4_DEFAULT([35, 36, 36, 35, 34, 33, 32, 31, 31, 30, 31, 31, 31, 31, 31, 29, 27]),
        M4_HIDE_EX(0),
        M4_UI_MODULE(curve),
...
typedef struct rk_irfpa_hw_texEst_params_s {
    /* M4_GENERIC_DESC(
        M4_ALIAS(dyn),
        M4_TYPE(struct_list),
        M4_SIZE_EX(1,4),
...
} rk_irfpa_hw_texEst_params_t;

typedef struct texEst_params_s {
    /* M4_GENERIC_DESC(
        M4_ALIAS(dyn),
        M4_TYPE(struct),
