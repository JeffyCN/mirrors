...
typedef struct btnr_frmFusion_dyn_s {
    /* M4_GENERIC_DESC(
        ...
        M4_DEFAULT(btnr_kalMdOnly_mode),
        M4_HIDE_EX(0),
        M4_RO(0),
        M4_ORDER(0),
...
typedef struct btnr_mdSigmaCurve_s {
    /* M4_GENERIC_DESC(
        ...
        M4_SIZE_EX(1,20),
        M4_RANGE_EX(0,4095),
        M4_DEFAULT([6000, 6200, 6400, 6600, 6800,7028, 7273, 7473, 7532, 7738, 7897, 7981, 7989, 8112, 8312, 8452, 8509, 9120, 9509, 9763]),
        M4_HIDE_EX(0),
        M4_RO(0),
        M4_ORDER(0),
        M4_NOTES(TODO))  */
    ...
    /* M4_GENERIC_DESC(
       ...
       M4_SIZE_EX(1,20),
       M4_RANGE_EX(0,4095),
       M4_DEFAULT([10,    10,   10,   10,   10,  10,   10,    10,   9,   8,   7,   6,   5,   5,   4,   4,   4,   4,   4,   4]),
       M4_HIDE_EX(0),
       M4_RO(0),
       M4_ORDER(1),
       M4_NOTES(TODO))  */
...
typedef struct btnr_sigmaAttrib_s {
    /* M4_GENERIC_DESC(
        ...
        M4_DEFAULT(btnr_pixLinearDomain_mode),
        M4_HIDE_EX(0),
        M4_RO(1),
        M4_ORDER(0),
...
typedef struct btnr_outFrm_s {
    /* M4_GENERIC_DESC(
        ...
        M4_DEFAULT(btnr_curBaseOut_mode),
        M4_HIDE_EX(0),
        M4_RO(0),
        M4_ORDER(0),
...
typedef struct rk_irfpa_hw_tnr_params_s {
    /* M4_GENERIC_DESC(
        M4_ALIAS(enable),
        M4_TYPE(bool),
        M4_DEFAULT(1),
    ...
    /* M4_GENERIC_DESC(
        ...
        M4_ORDER(2),
        M4_NOTES(TODO))  */
    btnr_mdMe_dyn_t mdMeDyn[BTNR42_ISO_STEP_MAX];
    /* M4_GENERIC_DESC(
        M4_ALIAS(spNrDyn),
        M4_SIZE_EX(1,4),
        M4_TYPE(struct_list),
        ...
        M4_ORDER(2),
        M4_NOTES(TODO))  */
    btnr_other_dyn_t spNrDyn[BTNR42_ISO_STEP_MAX];
} rk_irfpa_hw_tnr_params_t;

typedef struct tnr_params_s {
    /* M4_GENERIC_DESC(
        M4_ALIAS(sta),
        M4_TYPE(struct),
        M4_UI_MODULE(static_ui),
