...
#ifndef _RK_AIQ_PARAM_YNR41_H_
#define _RK_AIQ_PARAM_YNR41_H_

#define YNR_ISO_STEP_MAX 8
...
typedef struct ynr_coeff2SgmCurve_s {
    /* M4_GENERIC_DESC(
        ...
        M4_DEFAULT([-2.67741e-13, 2.12484e-9, -5.13656e-006, 0.0028146, 17.5758]),
        M4_DIGIT_EX(20),
        M4_HIDE_EX(0),
        M4_RO(0),
        M4_ORDER(0),
...
#define YNR_TEX2WGT_SEGMENT_MAX         9
...
typedef struct ynr_tex2NrOut_alpha_s {

} ynr_tex2NrOutAlpha_t;
...
typedef struct ynr_midNr_dyn_s {
    ...
    /* M4_GENERIC_DESC(
        ...
        Freq of use: low))  */
    // reg: hw_ynr_miSpnrFilt_coeff0~4
    ...
    /* M4_GENERIC_DESC(
        ...
        M4_RANGE_EX(0,1),
        M4_DIGIT_EX(4),
        M4_DEFAULT([0.2, 0.15, 0.05, 0.0, 0.0]),
        M4_HIDE_EX(0),
        M4_RO(0),
        M4_ORDER(1),
    ...
    float sw_ynr_filtSpatial_wgt[5];
    /* M4_GENERIC_DESC(
    ...
    /* M4_GENERIC_DESC(
        ...
        M4_HIDE_EX(0),
        M4_UI_MODULE(curve),
        M4_DATAX([0, 128, 256, 384, 512, 640, 768, 896, 1023]),
        M4_RO(0),
        M4_ORDER(1),
        M4_GROUP(miNr_en_group && tex2NrOutAlpha_en_group),
        M4_NOTES(....\n
        ....
        Freq of use: high))  */
    // @reg: hw_ynr_loSpnrGain2strg_val0~8
    float tex2NrOutAlpha[YNR_TEX2WGT_SEGMENT_MAX];
} ynr_midNr_dyn_t;
...
typedef struct ynr_loNrEPF_s {
    ...
    float hw_ynrT_softThd_scale;
    /* M4_GENERIC_DESC(
       M4_ALIAS(hw_ynrT_alphaLfTex_scale),
       M4_TYPE(f32),
       M4_SIZE_EX(1,1),
       M4_RANGE_EX(0.0,32.0),
       M4_DEFAULT(1.0),
       ...
       M4_RO(0),
       M4_ORDER(6),
       M4_NOTES(The scale of lowFreq texture that add to lo-nr result.
       Freq of use: high))  */
    //reg: hw_ynr_loEnhance_scale
    float hw_ynrT_alphaLfTex_scale;
    /* M4_GENERIC_DESC(
    ...
    /* M4_GENERIC_DESC(
        ...
        M4_RO(0),
        M4_ORDER(1),
        M4_GROUP(tex2NrOutAlpha_en_group),
        M4_NOTES(....\n
        ....
        Freq of use: high))  */
    // @reg: hw_ynr_loSpnrGain2strg_val0~8
...
typedef struct ynr_dsFlt_dyn_s {
    /* M4_GENERIC_DESC(
        M4_ALIAS(hw_ynrT_dsFlt_en),
        M4_TYPE(bool),
        M4_DEFAULT(1),
        M4_HIDE_EX(0),
        M4_RO(0),
        M4_ORDER(1),
        M4_GROUP_CTRL(dsFlt_en_group),
        M4_NOTES(Enable the ds filter for lo freq noise.Turn on by setting this bit to 1.
        Freq of use: high))  */
    bool hw_ynrT_dsFlt_en;
    /* M4_GENERIC_DESC(
       M4_ALIAS(hw_ynrT_dsFlt_strg),
       M4_TYPE(f32),
       M4_SIZE_EX(1,1),
       M4_RANGE_EX(0.0,1.0),
       M4_DEFAULT(0.0),
       ...
       M4_RO(0),
       M4_ORDER(6),
       M4_GROUP(dsFlt_en_group),
       M4_NOTES(Blending weight of input for lo-NR.
       Freq of use: high))  */
    //reg: hw_ynr_loSpnr_wgt
    float hw_ynrT_dsFlt_strg;
    /* M4_GENERIC_DESC(
       M4_ALIAS(hw_ynrT_diff_offset),
       M4_TYPE(f32),
       M4_SIZE_EX(1,1),
       M4_RANGE_EX(0.0,1.0),
       M4_DEFAULT(0.0),
...
typedef struct ynr_midLoNr_dyn_s {
    /* M4_GENERIC_DESC(
        M4_ALIAS(hw_ynrT_tex2NrOutAlpha_en),
        M4_TYPE(bool),
        M4_DEFAULT(1),
        M4_HIDE_EX(0),
        M4_RO(0),
        M4_ORDER(1),
        M4_GROUP_CTRL(tex2NrOutAlpha_en_group),
        M4_GROUP(miNr_en_group||loNr_en_group),
        M4_NOTES(Enable bit of text to nr out alpha.
        Freq of use: high))  */
    // reg: hw_ynr_tex2wgt_en
    bool hw_ynrT_tex2NrOutAlpha_en;
    /* M4_GENERIC_DESC(
        M4_ALIAS(midNr),
        M4_TYPE(struct),
        M4_UI_MODULE(normal_ui_style),
...
typedef struct rk_irfpa_hw_ynr_params_s {
    /* M4_GENERIC_DESC(
        M4_ALIAS(enable),
        M4_TYPE(bool),
        M4_DEFAULT(1),
    ...
    ynr_params_dyn_t dyn[YNR_ISO_STEP_MAX];
} rk_irfpa_hw_ynr_params_t;

typedef struct ynr_params_s {
    /* M4_GENERIC_DESC(
        M4_ALIAS(sta),
        M4_TYPE(struct),
        M4_UI_MODULE(static_ui),
