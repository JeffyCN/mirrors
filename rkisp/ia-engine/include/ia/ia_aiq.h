 ...
 *                                  AIC Block from CPFF. Contains tuning parameters for camera, ISP and AIQ algorithms.
 *                                  AIC depends on this parameters and running AIC will return a NULL pointer, if not given.
